...
//    textStyle: TextStyle = MyTheme.typography.bodyMedium,
//    shape: Shape = RoundedCornerShape(12.dp),
//    trailingIcon: @Composable (() -> Unit)? = null,
//    colors: TextFieldColors = TextFieldDefaults.colors(
//        focusedTextColor = MyTheme.colorScheme.textNormal,
//        focusedContainerColor = Color.Transparent,
//        focusedIndicatorColor = Color.Transparent,
//        unfocusedContainerColor = Color.Transparent,
//        unfocusedTextColor = MyTheme.colorScheme.textNormal,
//        unfocusedIndicatorColor = Color.Transparent,
//        disabledIndicatorColor = Color.Transparent,
//        disabledTextColor = MyTheme.colorScheme.textFieldTextDisabled,
...
//        targetValue = if (isFocused) MyTheme.colorScheme.textFieldPrimary else MyTheme.colorScheme.textFieldSecondary,
//        label = "",
//    )
//    val icon = if (!secured) {
...
//        enabled = enabled,
//        textStyle = textStyle.copy(color = MyTheme.colorScheme.textNormal),
...
//        cursorBrush = SolidColor(MyTheme.colorScheme.textFieldPrimary),
...
//                        text = hint,
//                        style = textStyle,
//                        color = if (enabled) MyTheme.colorScheme.textAlt else MyTheme.colorScheme.textFieldTextDisabled,
//                    )
//                },
//                label = null,
//                trailingIcon = {
